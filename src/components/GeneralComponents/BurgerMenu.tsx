...
const BurgerMenu = () : any => {
    ...
    <Menu styles={styles} customBurgerIcon={ <img className="w-1/12" src={burgerMenu} /> }>
        <div className="flex flex-col w-full">
          ...
          <div className='flex flex-row hover:bg-[#121212dd] hover:text-white pb-1 pl-5 hover:scale-110 cursor-pointer transition-all duration-200 hover:boxshadow3'><img className='mt-2 w-[2rem] h-[2rem] opacity-[0.7]' src={message}/><p className="menu-item text-[1.5rem] py-2 pl-3">Messages</p></div> 
