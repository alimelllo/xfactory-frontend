      ...
      <div className="flex flex-col h-[80%] justify-center">
        ...
        {/* <div className='bg-[#1c1c1ce5] rounded-[15px] w-[30%] boxshadow3 z-50'>
          ...
          <div className='bg-[#1c1c1ce5] rounded-[15px] w-[30%] boxshadow3 z-50'>
             ...
             <Link to="/CardsGame"><p className='text-white pb-3 text-[1.5rem] text-center z-50 rounded-[5px] mx-auto boxshadow2 w-7/12 bg-gradient-to-r from-[#9a4a2b] to-[#6e2d3c] cursor-pointer transition-all duration-200 hover:scale-105 tracking-[1px] pt-2 my-[3rem]'> Start Playing </p></Link>
          </div>
          <div className='bg-[#1c1c1ce5] rounded-[15px] w-[30%] boxshadow3 z-50'>
             ...
             <Link to="/RocketGame"><p className='text-white pb-3 text-[1.5rem] text-center z-50 rounded-[5px] mx-auto boxshadow2 w-7/12 bg-gradient-to-r from-[#244055] to-[#1e2838] cursor-pointer transition-all duration-200 hover:scale-105 tracking-[1px] hover:bg-[#0c9f0c] pt-2 my-[3rem]'> Start Playing </p></Link>
          </div>
        </div>
