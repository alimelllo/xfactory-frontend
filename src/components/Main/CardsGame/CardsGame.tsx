...
useEffect(() => {
    let arr = [ 'animate1' ,'animate2' ,'animate3','animate4','animate5' ,'animate6' ,'animate7' ,'animate8' ,'animate9' ,'animate10' , 'animate10' , 'animate9' , 'animate8' , 'animate7' , 'animate6' , 'animate5', 'animate4' , 'animate3' , 'animate2' , 'animate1'];
