   ...
   useEffect(() => {
    ...
    <>
       ...
       <div className="MESSANGER_CONTAINER   w-full h-[30rem] flex flex-row mt-[2rem] ">
           ...
           <div className="fixed w-[55%] bg-[#8c8888] top-[87%] flex flex-row boxshadow3 border-solid border-[1px] border-[#232323] ">
             ...
             <button onClick={() => {SetNewMessage({text : message , user : localStorage.getItem('userName')});   }} className="bg-[#521db4] w-2/12 text-white px-5">SEND</button></div> 
           </div>
       </div>
