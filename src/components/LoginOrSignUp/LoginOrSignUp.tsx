...
<div className='flex flex-col justify-center'>
    ...
    <div style={{ backgroundImage : `url(${main})`, backgroundSize :'cover' , backgroundPosition : 'center' }} className='h-[23rem] md:h-[20rem] rounded-[10px] flex mx-auto w-6/12 md:w-11/12 mt-[3rem] boxshadow2 opacity-[0.8] '>
